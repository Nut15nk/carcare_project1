! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        var t = new Date,
            ...
            o = this;
        // ตั้งค่า Moment locale เป็นภาษาไทย (ถ้ามี moment)
        ...
        o.$calendarObj = o.$calendar.fullCalendar({
            ...
            // แสดงรูปแบบวันที่เป็น วัน/เดือน/ปี
            ...
            listDayFormat: 'DD/MM/YYYY',
            timeFormat: 'HH:mm',
            // ดึงชื่อวัน/เดือนจาก moment (รองรับ locale)
            dayNames: (typeof moment !== 'undefined' ? moment.weekdays() : undefined),
            dayNamesShort: (typeof moment !== 'undefined' ? moment.weekdaysShort() : undefined),
            monthNames: (typeof moment !== 'undefined' ? moment.months() : undefined),
            monthNamesShort: (typeof moment !== 'undefined' ? moment.monthsShort() : undefined),
            events: a,
            editable: !0,
            droppable: !0,
            eventLimit: !0,
